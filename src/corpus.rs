...
//! its business.** Between PROTOCOL 2 and 15 exactly one shape a foot decodes
...
//! `last_seen` (14), `reply/follow`'s tool window (15) — and a
...
/// reads `pub const PROTOCOL: u32 = 15`, and this is that line copied.
///
...
/// train — and it has been moved four times now (bl-e0f0, bl-f88f, bl-dc5f,
/// bl-605f), the last two inside one session, on one day's release train.
pub(crate) const PROTOCOL: u32 = 15;
